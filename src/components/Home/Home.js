...
import bg from '../../images/cooking-bg.png';
...
const Home = () => {
    return (
        <div className='relative'>
            ...
            <h1 className='text-center text-lg md:text-4xl lg:text-6xl text-white font-mono font-semibold mb-20'>Full Fill Your Appetite</h1>
            </div>
        </div>
    );
};
